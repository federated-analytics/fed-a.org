...
If you wish to submit new code or content for this repository, we ask that you check locally that the website still builds. This can be done using a docker container with the relevant libraries. Below are instructions for doing this in VS Code.
...
To host this website locally install:
* [Visual Studio Code](https://code.visualstudio.com/download)
* [Docker](https://docs.docker.com/get-docker/)

Then install the **Dev Containers** extension for VS Code (see the [VS Code Dev Container tutorial](https://code.visualstudio.com/docs/devcontainers/tutorial) for more information on this).

A configuration file for a suitable Jekyll/Ruby container is included in this repository (`.devcontainer/devcontainer.json`), so you can then reopen the project in a dev container (use the blue connection button at the bottom left of the window to do this), which will be built from this configuration file.

Once you are in the dev container (which will be indicated in the blue button at the bottom left corner of the window), open a terminal and enter these commands to build and host the website:
